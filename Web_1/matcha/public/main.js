...
/* harmony import */ var _services_relay_comp_info_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/relay-comp-info.service */ "./src/app/services/relay-comp-info.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_15__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_14__["AuthService"], _services_relay_comp_info_service__WEBPACK_IMPORTED_MODULE_16__["RelayCompInfoService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_17__["AuthGuard"]],
...
module.exports = "<!-- <div class=\"jumbotron text-center\">\n  <h1>Matcha</h1>\n  <p class=\"lead\">Welcome to Matcha!</p>\n  <div>\n    <a class=\"btn btn-primary\" routerLink=\"/register\">Register</a>\n    <a class=\"btn btn-primary\" routerLink=\"/login\">Login</a>\n  </div>\n</div> -->\n\n<div class=\"jumbotron\">\n  <h1 class=\"display-3\">Welcome to Matcha!</h1>\n  <p class=\"lead\">This is a simple dating app, try not to bother others too much, thanks!</p>\n  <hr class=\"my-4\">\n  <p>Don't let the door hit you on your way out.</p>\n  <button type=\"button\" class=\"btn btn-primary\" routerLink=\"/register\" style=\"margin-right:8px;\">Register</button>\n  <button type=\"button\" class=\"btn btn-primary\" routerLink=\"/login\">Login</button>\n  <!-- <p class=\"lead\"> -->\n    <!-- <a class=\"btn btn-primary btn-lg\" href=\"#\" role=\"button\">Learn more</a> -->\n    <!-- <div class=\"btn-group\">\n      <a class=\"btn btn-primary\" routerLink=\"/register\">Register</a>\n      <a class=\"btn btn-primary\" routerLink=\"/login\">Login</a>\n    </div> -->\n  <!-- </p> -->\n</div>\n"
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-primary\" style=\"margin-bottom:15px\">\n  <a class=\"navbar-brand\" [routerLink]=\"['/']\">Matcha</a>\n  <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor01\" aria-controls=\"navbarColor01\" aria-expanded=\"false\" aria-label=\"Toggle navigation\" \n  (click)=\"toggleMobileDropdown()\">\n    <span class=\"navbar-toggler-icon\"></span>\n  </button>\n\n  <div [class]=\"mobMenu\" id=\"navbarColor01\">\n    <ul class=\"navbar-nav mr-auto\">\n      <li class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/']\">Home<span class=\"sr-only\">(current)</span></a>\n      </li>\n      <!-- Using authService.loggedIn() vs a variable set once works because detects state everytime -->\n      <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/dashboard']\">Dashboard</a>\n      </li>\n      <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/profile']\">Profile</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/register']\">Register</a>\n      </li>\n      <li *ngIf=\"!authService.loggedIn()\" class=\"nav-item\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact: true}\">\n        <a class=\"nav-link\" [routerLink]=\"['/login']\">Login</a>\n      </li>\n      <li *ngIf=\"authService.loggedIn()\" class=\"nav-item\">\n        <a class=\"nav-link\" (click)=\"onLogoutClick()\" href=\"#\">Logout</a>\n      </li>\n    </ul>\n    <form class=\"form-inline my-2 my-lg-0\">\n      <input class=\"form-control mr-sm-2\" type=\"text\" placeholder=\"Search\">\n      <button class=\"btn btn-secondary my-2 my-sm-0\" type=\"submit\">Search</button>\n    </form>\n  </div>\n</nav>\n"
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.toggleMobileDropdown = function () {
...
module.exports = "<!-- Checking if user is true before displaying content. -->\n<div *ngIf=\"user\">\n  <h2 class=\"page-header\">{{user.name}}</h2>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">Username: {{user.username}}</li>\n    <li class=\"list-group-item\">Email: {{user.email}}</li>\n  </ul>\n</div>"
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        var regHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"];
...
/***/ "./src/app/services/relay-comp-info.service.ts":
/*!*****************************************************!*\
  !*** ./src/app/services/relay-comp-info.service.ts ***!
  \*****************************************************/
/*! exports provided: RelayCompInfoService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RelayCompInfoService", function() { return RelayCompInfoService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var RelayCompInfoService = /** @class */ (function () {
    function RelayCompInfoService() {
    ...
    RelayCompInfoService.prototype.getSubjectObs = function () {
    ...
    RelayCompInfoService.prototype.showNavbarLogin = function (val) {
        this.subject.next(val);
    };
    RelayCompInfoService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], RelayCompInfoService);
    return RelayCompInfoService;
}());
...
module.exports = __webpack_require__(/*! /Users/1humble1/Desktop/WeThinkCode_Projects/Web_1/matcha/angular-src/src/main.ts */"./src/main.ts");
